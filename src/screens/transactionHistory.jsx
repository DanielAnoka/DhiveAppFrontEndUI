        ...
        <SafeAreaView style={styles.safeArea}>
            <View style={styles.container}>
                ...
                <View style={styles.headerRow}>
                    ...
                    <TouchableOpacity style={styles.iconCircle3} onPress={() => setFilterModalVisible(true)}>
                ...
                <View style={{ flex: 1, marginHorizontal: 10 }}>
                    {filteredAssets.length > 0 ? (
                        ...
                        <View style={styles.noTransactionsContainer}>
                            <Image source={Images.Empty} style={styles.noTransactionsImage} resizeMode="contain" />
                    ...
                    <View style={styles.modalContainer}>
                        ...
                        <View style={styles.modalHeader}>
                            ...
                            <TouchableOpacity onPress={() => toggleModal(null)}>
                                <Icon name="x" style={styles.iconCircleX} size={22} color="#000" />
                            </TouchableOpacity>
                        </View>
                        ...
                        <View style={styles.tokenSection}>
                            ...
                            <Text style={styles.amountText}>${selectedTransaction.price?.toFixed(2)}</Text>
                        ...
                        <View style={styles.detailsBox}>
                            <DetailRow label="Swap From" value={`${selectedTransaction.amount} ${selectedTransaction.name}`} />
                        ...
                        <Text style={styles.supportText}>
                            ...
                            Reach out to us via our <Text style={styles.supportLink}>Support Channel</Text>.
                        </Text>
                    </View>
                </Animated.View>
            )}
