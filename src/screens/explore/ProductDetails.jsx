        ...
        ListHeaderComponent={
          <ContainerWrapper>
            ...
            <Text className="mt-5 text-[#535862] text-sm">
              ...
              latest Sport Loop is carbon neutral. WHY APPLE WATCH SERIES 9 —
              Your essential companion for a healthy life is now even more
              powerful. The S9 chip enables a super-bright display and a magical
              new way to quickly and easily interact with your Apple Watch
              without touching the screen. Advanced health, safety and activity
              features provide powerful insights and help when you need it. And
              redesigned apps in watchOS give you more information at a glance.
            </Text>
        ...
        ListFooterComponent={
          <View>
            ...
            <FlatList
              ...
              numColumns={2}
              ListFooterComponent={<PrimaryButton text={"Buy Product"} />}
            />
          </View>
        }
      />
