...
import {
    View, Text, Image, StyleSheet, SafeAreaView, TouchableOpacity, TextInput, Animated, Dimensions, TouchableWithoutFeedback,
    Keyboard, Alert
} from 'react-native';
        ...
        <SafeAreaView style={styles.safeArea}>
            <View style={styles.container}>
                ...
                <View style={styles.footer}>
                    <Text style={styles.footerText}>≈ $ {convertToUSD(amount || 0).toFixed(2)}</Text>
                ...
                <CustomButton text="Continue" style={styles.importButton} onPress={toggleModal} />
            </View>
            {(modalVisible || modalVisible2 || modalVisible3) && <View style={styles.overlay} />}
                    ...
                    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                        <View style={styles.modalContent2}>
                            ...
                            <View style={styles.textContainer}>
                                ...
                                <Text style={styles.modalSubText}>Use your PIN code to authorize this {'\n'}transaction</Text>
                            </View>
                ...
                >
                    <View style={styles.modalContent}>
                        ...
                        <View style={styles.textContainer}>
                            ...
                            <Text style={styles.modalSubText}>Your transfer of 392.45 USDT was successful</Text>
                        </View>
