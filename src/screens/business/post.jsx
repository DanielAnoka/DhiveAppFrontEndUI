    ...
    return (
        <SafeAreaView className="flex-1 bg-white ">
            ...
            <View className="items-center px-4 pb-4">
                ...
                <Text className="mt-2 text-base font-semibold">SwiftRole</Text>
                <Text className="text-sm text-gray-500">$MART</Text>

                <View className="mt-3 ">
                    <Text className=" text-sm font-medium">Empowering businessess through tokenization</Text>
                </View>
            </View>
