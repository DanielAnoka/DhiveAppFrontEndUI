...
import { Post, analyticsData } from '../../constants';
    ...
    return (
        <View className="mt-6">
            <ScrollView showsVerticalScrollIndicator={false} className="px-4">
                ...
                <View className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm min-h-[120px]">
                    <View className="flex-row justify-between items-start mb-2">
                        <Text className="text-[15px] text-[#383B42] font-[400]">Follower Growth</Text>
                        <TouchableOpacity >
                            <Icon name="information-circle-outline" size={18} color="#888" />
                        </TouchableOpacity>
                    </View>
                    ...
                    <View className="">
                        <View className="flex-row items-center justify-between">
                            <View className="flex-row items-center gap-x-1">
                                <Text className="text-xl font-semibold">16,894</Text>
                            </View>
                ...
                <View className="bg-white border border-gray-200 rounded-xl p-4 mt-5 shadow-sm min-h-[120px]">
                    <View className="flex-row justify-between items-start mb-2">
                        <Text className="text-[15px] text-[#383B42] font-[400]">Top 3 Performing Post</Text>
                        <TouchableOpacity >
                            <Icon name="information-circle-outline" size={18} color="#888" />
                        </TouchableOpacity>
                    </View>
