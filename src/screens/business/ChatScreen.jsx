...
export default function ChatScreen() {
    return (
        <SafeAreaView className="flex-1 bg-white">
            <View className="relative pb-6 mt-16">
                <LinearGradient
                    colors={['#E0C3FC', '#8EC5FC']}
                    className="h-20 "
                />
                <View className="absolute bottom-[-35] left-4  right-9 flex-row items-end justify-between">
                    <Image
                    ...
                    <View className="flex-row items-center gap-2 mb-1">
                        <View className="flex-row items-center">
                            <Image source={Images.AU} className="w-[14px] h-[14px] mr-1" />
                            <Text className="text-sm text-gray-900">$STL</Text>
                        </View>
                        <View className="flex-row items-center">
                            <Image source={Icons.Users} className="w-[14px] h-[14px] mr-1" />
            ...
            <View className="flex-row items-center mt-1 px-5" style={{ flexWrap: 'nowrap' }}>
                {/* Wallet Tag */}
                <View className="flex-row items-center rounded-full px-2 py-0.5 mr-2" style={{ backgroundColor: '#D5D9EB' }}>
                    <View className="w-2 h-2 rounded-full bg-gray-400 mr-1" />
                    <Text className="text-xs text-gray-600" style={{ fontWeight: '500' }}>
                        Ox79...107hg
                    </Text>
                </View>

                {/* Technology Tag */}
                <View className="flex-row items-center rounded-full px-2 py-0.5 mr-2" style={{ backgroundColor: '#DBEAFE' }}>
                    <View className="w-2 h-2 rounded-full bg-blue-500 mr-1" />
                    <Text className="text-xs text-blue-800" style={{ fontWeight: '500' }}>
                        Technology
                    </Text>
                </View>

                {/* Cashback Tag */}
                <View className="flex-row items-center rounded-full px-2 py-0.5" style={{ backgroundColor: '#DCFCE7' }}>
                    <View className="w-2 h-2 rounded-full bg-green-500 mr-1" />
                    <Text className="text-xs text-green-800" style={{ fontWeight: '500' }}>
                        Cash Back - 20%
                    </Text>
                </View>
            </View>
