...
import StepIndicator from "../trade-products/StepIndicator";
import Table from "../trade-products/Table";
import CryptoChart from "../trade-products/Chart";

const Trade = ({ onClick }) => {
    return (
        <ScrollView>
            <View className="pb-64">
                <View className="bg-white  pt-5 mx-1  mt-5 rounded-xl">
                    <View className=" w-full border bg-white border-[#E9E9E9]  rounded-xl  p-5">
